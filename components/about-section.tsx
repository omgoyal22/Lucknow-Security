...
export function AboutSection() {
  return (
    <section
      id="about"
      className="relative py-20 min-h-[80vh] flex items-center justify-center bg-muted/30"
      style={{
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-4 flex flex-col gap-8">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-4 text-white/80 max-w-xl">
          ...
          <div className="flex flex-row gap-4 justify-center">
            {objectives.map((objective, index) => (
              <Card key={index} className="w-64 bg-white/90 border-none shadow-lg">
